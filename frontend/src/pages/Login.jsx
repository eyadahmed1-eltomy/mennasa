...
export default function Login() {
  ...
  const { login, loginWithGoogle, requestPersistentLogin } = useAuth();
        ...
        <div className="animate-in fade-in slide-in-from-right-8 duration-700">
          <form className="glass-card p-10 rounded-3xl border border-white/10 shadow-2xl space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative flex items-center justify-center py-2">
               ...
               <span className="relative bg-[#0b0c10] px-4 text-gray-600 text-[0.65rem] font-black uppercase tracking-[0.2em]">Or Continue With</span>
            </div>
